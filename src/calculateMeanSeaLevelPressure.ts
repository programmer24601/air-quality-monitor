...
export const calculateMeanSeaLevelPressure = (
  ...
  const p = bmp280MeasurementData.localPressure * 100; // sea level standard atmospheric pressure (Pa)
  ...
  const meanSeaLevelPressure = Math.round(p_0) / 100; // convert Pa to hPa and round to two decimal places
